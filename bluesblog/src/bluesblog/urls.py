...
from blog.views import NewBlogView, HomeView, UpdateBlogView, NewBlogPostView, BlogPostDetailsView, UpdateBlogPostView, ShareBlogPostView, SharePostWithBlog, StopSharingPostWithBlog
